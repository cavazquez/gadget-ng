...
mod tests {
    ...
    #[test]
    fn merger_tree_links_snapshots_by_shared_particles() {
        let halos_old = vec![make_halo(0, 5, 1e14)];
        ...
        let old_node = forest
            ...
            .iter()
            .find(|n| n.snapshot == 0)
            .expect("nodo snapshot antiguo");
        assert_eq!(old_node.prog_main_id, Some(0));
    }
